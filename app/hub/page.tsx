export default function hub() {
    ...
    <main className="py-8 sm:py-12 mt-0 flex-grow bg-gray-100">
        <div className="max-w-7xl mx-auto px-2 mt-12 sm:px-6 lg:px-8">
            ...
            {/* HEADER */}
            <header className="bg-white shadow-xl rounded-md p-6 sm:p-8 mb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div className="lg:col-span-2" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div className="bg-white shadow-lg rounded-md p-5 sm:p-6">
                        ...
                        <ul id="recent-inspections-list" className="space-y-4">
                            <li
                                className="p-4 bg-gray-50 rounded-md border border-gray-200 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                        ...
                        <button
                            className="mt-6 w-full py-2 border border-gray-300 rounded-md text-gray-600 hover:bg-gray-100 transition">
                            View All Reports
                        </button>
                    </div>
                ...
                <div className="space-y-6" data-aos="fade-left" data-aos-duration="1000">
                    ...
                    <div className="bg-white shadow-lg rounded-md p-5 sm:p-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="bg-green-50 p-3 rounded-md flex justify-between">
                                <span className="text-green-700">Inspections Today:</span>
                                <span className="font-bold text-green-900">3</span>
                            </div>

                            <div className="bg-red-50 p-3 rounded-md flex justify-between">
